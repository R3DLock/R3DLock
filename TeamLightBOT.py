...
bot.run(bot.run(os.environ('NTQxNjU3NTg5NjAwMjIzMjM0.DziuZQ.AlTHzoR1jXwgumjjkuTME3FQojs'))) #Lancer le bot. Remplacez token par votre token et laissez les apostrophes
